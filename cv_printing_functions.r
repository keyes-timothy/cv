...
print_skill_bars <- function(cv, skill_type = "programming", out_of = 5, bar_color = "#969696", bar_background = "#d9d9d9", glue_template = "default"){
...
print_contact_info <- function(cv){
  # cv$contact_info %<>% 
  #   dplyr::mutate(contact =  ifelse(grepl("linkedin", loc), create_linkedin_url(contact), contact))
  # 
    glue::glue_data(
    cv$contact_info,
